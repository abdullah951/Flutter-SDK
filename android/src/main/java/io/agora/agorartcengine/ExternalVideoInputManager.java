...
import io.agora.agorartcengine.gles.core.GlUtil;
...
public class ExternalVideoInputManager implements IVideoSource {
    ...
    private FlutterApplication mApplication;
    ...
    public ExternalVideoInputManager(FlutterApplication application) {
    ...
    void start() {
        ...
        mThread.start();
        Log.d(TAG, "start: Thread Started");
    }
...
//                }
            ...
            case TYPE_SCREEN_SHARE:
                ...
                Log.d(TAG, "setExternalVideoInput: ExternalVideoInputManager ");
                break;
            default:
                 input = null;
        }
    ...
    private class ExternalVideoInputThread extends Thread {
        ...
        private void prepare() {
            ...
            if(AgoraRtcEnginePlugin.context != null)
                AgoraRtcEnginePlugin.getRtcEngine().setVideoSource(ExternalVideoInputManager.this);
        }

        private void release() {
            if(AgoraRtcEnginePlugin.context != null)
            AgoraRtcEnginePlugin.getRtcEngine().setVideoSource(null);
            mSurface.release();
